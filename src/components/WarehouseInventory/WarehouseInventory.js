    ...
    <section className="main">
      <section className="main__tabdesk">
        <article className="main__tabdesk--data InventoryName">
          <span className="main__tabdesk-data--name">
            {Inventory.item_name}
          </span>
          <img className="main__tabdesk-content-icon" src={linkIcon} alt="" />
        </article>
        <span className="main__tabdesk--data">{Inventory.category}</span>
        <span
          className="main__tabdesk--data statusColour"
        ...
        <article className="main__tabdesk-content-iconbox main__tabdesk--data">
          <img
            className="main__tabdesk-content-iconbox--icon"
            src={deleteIcon}
            alt=""
          />
          <img
        ...
        <article className="main__mobile-content">
          <article className="main__mobile-content-box1">
            <div className="main__mobile-content-box1-item">
              ...
              <span className="main__mobile--itemName">
                {Inventory.item_name} &gt;
              </span>
            </div>
            <div className="main__mobile-content-box1-item">
          ...
          <article className="main__mobile-content-box1">
            <div className="main__mobile-content-box1-item">
              ...
              <span
                className="main__mobile--data statusColour"
                style={{ color: statusColor }}
              >
                {Inventory.status}
              </span>
