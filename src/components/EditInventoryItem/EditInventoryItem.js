      ...
      <div className="itemDetailsContainer">
        ...
        <div className="itemDetailsName">
          ...
          <div>
            <div>
              <label>
                <textarea className="textFiledName" type="text" name="name" placeholder="123"></textarea>
              </label>
            </div>
          </div>
        </div>
        ...
        <div className="itemDetailsDes">
          ...
          <div>
            <div>
              <label>
                <textarea className="textFiledDes" type="text" name="description" placeholder="456"></textarea>
              </label>
            </div>
          </div>
        </div>
      ...
      <div className="itemAvailabilityContainer">
        ...
        <div className="itemDetailsButton">
          ...
          <div className="itemDetailsButton__cancel">
            <button className="ctaSecondary"  type="button">Cancel</button>
          </div>

          <div className="itemDetailsButton__save" >
            <button  className="ctaPrimary" type="button">Save</button>
          </div>
